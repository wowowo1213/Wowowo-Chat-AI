<template>
  ...
  >
    ...
    <div class="mt-4 w-full flex justify-center">
      <button
        class="px-4 py-2 rounded-lg cursor-pointer text-white bg-blue-500 0 hover:bg-blue-700 dark:bg-gray-700 dark:hover:bg-gray-800 transition-colors duration-200"
